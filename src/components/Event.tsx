...
//   const { user, isLoggedIn } = useAuth(); // Access auth state

//   useEffect(() => {
//     const fetchEvents = async () => {
//       console.log("BACKEND_URL for events:", BACKEND_URL);
//       try {
//         setIsLoading(true);
//         const token = localStorage.getItem('token'); // Use token from auth
...
//     fetchEvents();
//   }, [isLoggedIn]); // Re-fetch if login state changes

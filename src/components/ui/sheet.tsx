...
//         side === "left" && "inset-y-0 left-0 w-full md:w-[500px] data-[state=closed]:-translate-x-full data-[state=open]:translate-x-0",
...
//     >
//       {children}
//       <SheetPrimitive.Close className="absolute right-4 top-10 rounded-sm opacity-70 duration-500 ease-in-out data-[state=open]:opacity-100 data-[state=closed]:opacity-0 transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none">
//         <X className="h-4 w-4" />

  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        setError(
          "Failed to load events. Please check your authentication or try again later."
        );
        setEvents([]);
      } finally {
        setIsLoading(false);
          ...
          ? events.map((event: EventType, index) => (
              ...
              >
                ...
                <div className="flex flex-col items-start px-5 gap-1.5 py-3">
                  <h3 className="text-[14px] text-[#8C8C8C]">
                    {event.category}
                  </h3>
                  ...
                  <div className="flex items-center gap-2">
                    <Image
                      ...
                      alt="event"
                    />
                    <p className="text-[14px] text-[#212529] line-clamp-1">
